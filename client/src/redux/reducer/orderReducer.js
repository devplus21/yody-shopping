...
export const myOrdersReducer = (state = { orders: [], loading: false }, action) => {
	switch (action.type) {
...
export const allOrdersReducer = (state = { orders: [], loading: false }, action) => {
	switch (action.type) {
		case ALL_ORDERS_REQUEST:
		case ALL_USER_ORDERS_REQUEST:
			return {
				loading: true
			};
